...
<div class="container my-5">
	<div class="text-end">
		<a href="{{ url('dashboard/find-item') }}" class="text-dark"><i class="fa fa-arrow-left"></i> Kembali</a>
	</div>
	<div class="card">
		<div class="card-body">
			<form action="{{ url('dashboard/find-item/'.$item->id.'/edit') }}" method="POST" enctype="multipart/form-data">
				@csrf @method('PUT')
				<div>
					<h5>Detail Barang</h5>
					<hr/>
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group mb-3 @error('find_date') has-error @enderror">
								<label>Tanggal Menemukan <span class="text-danger">*</span></label>
								<input type="date" name="find_date" class="form-control" placeholder="Tanggal Menemukan" required value="{{ date('Y-m-d', strtotime($item->find_date)) }}">
								@error('find_date')
								<span class="help-block">{{ $message }}</span>
								@enderror
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group mb-3 @error('location_id') has-error @enderror">
								<label>Lokasi Penemuan <span class="text-danger">*</span></label>
						...
						<div class="col-md-6">
							...
							<div class="form-group mb-3 @error('specific_location') has-error @enderror">
								...
								<textarea name="specific_location" class="form-control" required rows="5" placeholder="Detail lokasi penemuan barang...">{{ $item->specific_location }}</textarea>
