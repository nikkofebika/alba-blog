...
<div class="container my-5">
	...
	<div class="card">
		<div class="card-body">
			<form action="{{ url('dashboard/find-item/create') }}" method="POST" enctype="multipart/form-data">
				@csrf
				<div>
					<h5>Detail Barang</h5>
					<hr/>
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group mb-3">
								...
								<input type="date" name="find_date" class="form-control" placeholder="Tanggal Menemukan" required>
							</div>
							<div class="form-group mb-3">
							...
							<div class="form-group mb-3">
								...
								<textarea name="description" class="form-control" required rows="5" placeholder="Deskripsikan barang yang anda temukan..."></textarea>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group mb-3">
								...
								<textarea name="specific_location" class="form-control" required rows="5" placeholder="Detail lokasi penemuan barang..."></textarea>
							</div>
						</div>
					</div>
				</div>
